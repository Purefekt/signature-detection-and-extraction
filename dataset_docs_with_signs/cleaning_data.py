...
This dataset_docs_with_signs has 1290 scanned pages of documents containing printed text, signatures and logos. All images do not have
a signature, this is also defined in the ground truth data. This script goes through the ground truth xml files and 
flags and removes the xml files and the image files for which there is no signature in the image.
There were 776 such images.
New dataset_docs_with_signs is here: https://www.kaggle.com/veersingh230799/documents-with-signatures/settings
"""
